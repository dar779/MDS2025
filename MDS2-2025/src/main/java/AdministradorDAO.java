...
public class AdministradorDAO {
	public static Administrador loadAdministradorByORMID(String login) throws PersistentException {
		try {
			PersistentSession session = ProyectoMDS120242025PersistentManager.instance().getSession();
			return loadAdministradorByORMID(session, login);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Administrador getAdministradorByORMID(String login) throws PersistentException {
		try {
			PersistentSession session = ProyectoMDS120242025PersistentManager.instance().getSession();
			return getAdministradorByORMID(session, login);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(String login, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = ProyectoMDS120242025PersistentManager.instance().getSession();
			return loadAdministradorByORMID(session, login, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(String login, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = ProyectoMDS120242025PersistentManager.instance().getSession();
			return getAdministradorByORMID(session, login, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, String login) throws PersistentException {
		try {
			return (Administrador) session.load(Administrador.class, login);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, String login) throws PersistentException {
		try {
			return (Administrador) session.get(Administrador.class, login);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, String login, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.load(Administrador.class, login, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, String login, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.get(Administrador.class, login, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(Administrador administrador) throws PersistentException {
		try {
			ProyectoMDS120242025PersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Administrador administrador) throws PersistentException {
		try {
			ProyectoMDS120242025PersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(Administrador administrador)throws PersistentException {
		try {
			Usuario[] lUsuarios = administrador.usuario.toArray();
			for(int i = 0; i < lUsuarios.length; i++) {
				lUsuarios[i].setAdministradorBan(null);
			}
			Comentario[] lComentarios = administrador.comentario.toArray();
			for(int i = 0; i < lComentarios.length; i++) {
				lComentarios[i].setAdministrador(null);
			}
			Usuario[] lUsuarioAdmins = administrador.usuarioAdmin.toArray();
			for(int i = 0; i < lUsuarioAdmins.length; i++) {
				lUsuarioAdmins[i].setAdministrador(null);
			}
			Tweet[] lTweets = administrador.tweet.toArray();
			for(int i = 0; i < lTweets.length; i++) {
				lTweets[i].setAdministrador(null);
			}
	...
	public static boolean refresh(Administrador administrador) throws PersistentException {
		try {
			ProyectoMDS120242025PersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Administrador administrador) throws PersistentException {
		try {
			ProyectoMDS120242025PersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
