...
@Tag("vista-verhashtagregistrado")
@JsModule("./views/vista-verhashtagregistrado.ts")
public class VistaVerhashtagregistrado extends LitTemplate {
	...
	public VistaVerhashtagregistrado() {
