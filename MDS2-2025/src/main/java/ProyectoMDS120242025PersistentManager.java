...
public class ProyectoMDS120242025PersistentManager extends PersistentManager {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(Autentificado.class);
		...
		aMetadataSources.addAnnotatedClass(Tweet.class);
		aMetadataSources.addAnnotatedClass(Usuario.class);
		aMetadataSources.addAnnotatedClass(Multimedia.class);
		aMetadataSources.addAnnotatedClass(Baneo.class);
	}
