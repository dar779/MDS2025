...
<vaadin-vertical-layout id="vaadinVerticalLayout3" style="width: 100%; height: 100%;">
 <vaadin-horizontal-layout class="content" style="width: 100%; height: 100%;" id="vaadinHorizontalLayout">
  <vaadin-vertical-layout id="vaadinVerticalLayout1" style="width: 20%;"></vaadin-vertical-layout>
  <vaadin-vertical-layout id="vaadinVerticalLayout2" style="width: 60%;">
   <vaadin-vertical-layout id="usuaios" style="width: 100%; height: 85%; margin-bottom: var(--lumo-space-m);"></vaadin-vertical-layout>
